...
class _ScheduleAvailabilityPageState extends State<ScheduleAvailabilityPage> {
  ...
  Future<void> _showAddTimesModal() async {
    final availableHours = List.generate(
      13,
          ...
          builder: (ctx, setModal) {
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    AppLocalizations.of(context)!.selectAvailableHours,
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: selectedHours.isEmpty || _doctorId == null
                          ? null
                          : () async {
                              await context
                                  .read<AvailabilityCubit>()
                                  .addMultipleAvailabilities(
                                    doctorId: _doctorId!,
                                    date: _selectedDate
                                        .toIso8601String()
                                        .substring(0, 10),
                      ...
                      child: Text(
                        AppLocalizations.of(context)!.addTimes,
                        style: const TextStyle(
                          fontWeight: FontWeight.bold,
                          color: Colors.white,
                        ),
  ...
  Future<void> _confirmDelete(BuildContext ctx, int availabilityId) async {
    final bool? confirmed = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text(AppLocalizations.of(context)!.deleteSlotMessage),
        actions: [
          TextButton(
    ...
    if (confirmed == true && _doctorId != null) {
      await context.read<AvailabilityCubit>().deleteAvailabilityById(
        availabilityId,
        _doctorId!,
      );
    }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      AppLocalizations.of(context)!.availableSlotsFor(dateKey),
                      style: const TextStyle(
                    ...
                    Expanded(
                      child: (slotsForDay.isEmpty)
                          ? Center(
                              child: Text(
                                AppLocalizations.of(context)!.noTimesForDay,
                              ),
                            )
                          : ListView.builder(
