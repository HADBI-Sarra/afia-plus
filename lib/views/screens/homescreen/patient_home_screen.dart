...
class _PatientHomeScreenState extends State<PatientHomeScreen> {
  ...
  // UI building helpers
  // -----------------------
  Widget sectionTitle(BuildContext context, String title, {VoidCallback? onSeeAll}) {
    return Row(
      children: [
                  ...
                  child: ListView(
                    ...
                    children: doctorsForSpeciality.map((doctor) {
                      ...
                      final String specialty =
                          doctor['speciality_name'] ?? selectedSpecialityName ?? '';
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 20),
                              sectionTitle(context, 'Popular specializations', onSeeAll: () {
                                setState(() {
                                  showAllSpecialities = true;
                                });
                              }),
